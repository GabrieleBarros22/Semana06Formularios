...
@app.route('/user/<name>/<institution>/<disciplina>')
def user(name, institution, disciplina):
    return render_template('user.html', name=name, institution=institution, disciplina=disciplina)
